...
def test_remove_insert_absence_time_list():
    ...
    assert w1.allocated_worker_id_record == ["aa", "bb", "cc", "ff", "ff", "ff"]
    assert w1.allocated_facility_id_record == ["aa", "bb", "cc", "ff", "ff", "ff"]
    assert w1.state_record_list == [0, 1, 2, 5, 5, 5]
    assert w2.allocated_worker_id_record == ["aa", "bb", "cc", "ff", "ff", "ff"]
    assert w2.allocated_facility_id_record == ["aa", "bb", "cc", "ff", "ff", "ff"]
    assert w2.state_record_list == [0, 1, 2, 5, 5, 5]
