...
def test_init(dummy_facility):
    ...
    assert dummy_facility.assigned_task_id_set == set()
    w = BaseFacility(
        "w1",
        solo_working=True,
