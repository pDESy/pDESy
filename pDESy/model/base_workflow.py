...
class BaseWorkflow(object, metaclass=abc.ABCMeta):
    ...
    def plot_simple_gantt(
        ...
        return workflow_viz.plot_simple_gantt(
            self,
    ...
    def create_simple_gantt(
        ...
        return workflow_viz.create_simple_gantt(
            self,
            target_id_order_list=target_id_order_list,
            finish_margin=finish_margin,
            print_workflow_name=print_workflow_name,
    ...
    def create_data_for_gantt_plotly(
        ...
        return workflow_viz.create_data_for_gantt_plotly(
            self,
            init_datetime,
            unit_timedelta,
            target_id_order_list=target_id_order_list,
    ...
    def create_gantt_plotly(
        ...
        return workflow_viz.create_gantt_plotly(
            self,
            init_datetime,
            unit_timedelta,
            target_id_order_list=target_id_order_list,
    ...
    def get_networkx_graph(self):
        ...
        return workflow_viz.get_networkx_graph(self)
    ...
    def draw_networkx(
        ...
        **kwargs,
        ...
        return workflow_viz.draw_networkx(
            self,
            g=g,
            pos=pos,
            arrows=arrows,
    ...
    def get_node_and_edge_trace_for_plotly_network(
        ...
        return workflow_viz.get_node_and_edge_trace_for_plotly_network(
            self,
            g=g,
            pos=pos,
            node_size=node_size,
    ...
    def draw_plotly_network(
        ...
        return workflow_viz.draw_plotly_network(
            self,
            g=g,
            pos=pos,
            title=title,
