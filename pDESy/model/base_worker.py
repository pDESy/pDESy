...
class BaseWorker(MermaidDiagramMixin, AssignedPairsMixin, object, metaclass=abc.ABCMeta):
    """BaseWorker.
    ...
    def get_time_list_for_gantt_chart(self, finish_margin: float = 1.0):
        ...
        """
        state_to_bucket = {
            BaseWorkerState.FREE: "ready",
            BaseWorkerState.WORKING: "working",
            BaseWorkerState.ABSENCE: "absence",
        }
